...
from scripts.data_loader.data_preprocessor_without_audio import DataPreprocessor
import pyarrow
...
def word_seq_collate_fn(data):
    ...
    word_seq, poses_seq, aux_info = zip(*data)
    ...
    return word_seq, words_lengths, poses_seq, aux_info
...
class TwhDataset(Dataset):
    ...
    def __getitem__(self, idx):
        with self.lmdb_env.begin(write=False) as txn:
            ...
            word_seq, pose_seq, _, aux_info = sample
        ...
        return word_seq_tensor, pose_seq, aux_info
